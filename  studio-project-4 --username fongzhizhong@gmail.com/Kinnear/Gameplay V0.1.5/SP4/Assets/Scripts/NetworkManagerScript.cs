...
public class NetworkManagerScript : MonoBehaviour {
	...
	public static NetworkManagerScript NetworkInstance;
	...
	void Start () {
		...
		if (NetworkInstance != null && NetworkInstance != this) 
		{
...
//		MasterServer.port = 23466;
	...
	public void spawnPlayer () {
		...
		Network.Instantiate (playerPrefab, spawnObject, Quaternion.identity, 0);
		Debug.Log ("Test");
	}
